...
const fetchCoinPrices = async (coinIds: string[]) => {
  ...
  // Reverting to /simple/price as /coins/markets endpoint also seems to be failing.
  // This endpoint returns data in the correct format without needing transformation.
  ...
  console.log('Fetched portfolio prices:', prices); // Added for debugging
  return prices;
};
